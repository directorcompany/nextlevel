                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<form method='post' action="{{route('user.store')}}" >
                                    ...
                                    <div class="form-group">
                                    <label class="control-lable" for="occupation">Занятие</label>
                                    <div class="controls">
                                        <input type="text" name="occupation" class="form-control @error('question') border-red @enderror" placeholder="occupation" value="{{old('occupation')}}" >
                                    </div>
                                     @error('occupation')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="controls">
                                        <input type="number" name="phone" class="form-control @error('phone') border-red @enderror" placeholder="phone" value="{{old('phone')}}">
                                    </div>
                                     @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
