            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" name="name" placeholder="Имена из тестов" value="<?php echo e(old('name')); ?>">
                             <br>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="controls">
                            ...
                            <textarea name="description"  class="form-control" placeholder="Описание тестов"></textarea>
                             <br>
